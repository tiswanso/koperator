...
require (
	...
	github.com/banzaicloud/go-cruise-control v0.5.0
	...
	istio.io/istio v0.0.0-20230325092655-3c20e74ebcb9
	k8s.io/api v0.26.1
...
require (
	...
	istio.io/client-go v1.15.7-0.20230322185424-f419270783b9 // indirect
...
replace (
	github.com/banzaicloud/koperator/test/pkg/helm => ./test/pkg/helm
